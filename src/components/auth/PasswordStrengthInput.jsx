  ...
  return (
    <View style={styles.container}>
      <View style={styles.inputWrapper}>
        ...
        {/* Les boutons d'action sont intégrés de manière fixe dans le champ */}
      ...
      {/* La jauge ne s'affiche que si on tape, mais elle ne casse pas le layout car on lui donne un espace fluide */}
      {password.length > 0 && (
        <View style={styles.gaugeContainer}>
          ...
          <View style={styles.requirementsBox}>
            <PasswordRequirement met={stats.length} text="12 car. min." />
