  ...
  rider: [
    {
      ...
      videoSource: require('../../assets/videos/riderhelp.mp4'), 
    },
    {
      id: 'rider-2',
      title: 'Gérer mon profil et mes trajets',
      description: 'Configurez votre compte et consultez votre historique en toute sécurité.',
      videoSource: require('../../assets/videos/riderhelp.mp4'), // Placeholder en attendant ta deuxième vidéo
    }
  ],
  driver: [
    {
      ...
      videoSource: require('../../assets/videos/driverhelp.mp4'),
    },
    {
      id: 'driver-2',
      ...
      videoSource: require('../../assets/videos/driverhelp.mp4'), // Placeholder en attendant ta deuxième vidéo
    }
  ]
};